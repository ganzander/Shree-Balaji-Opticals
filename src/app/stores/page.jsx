    ...
    <>
      <div className="min-h-screen pt-24 w-full flex items-center justify-center bg-[#F6F5F2] dark:bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        ...
        <div className="flex flex-col items-center">
          <h2 className="w-full text-center pb-5 text-lg sm:md:text-2xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 font-sans">
            Shree Balaji Opticals Store
          </h2>
          <iframe
